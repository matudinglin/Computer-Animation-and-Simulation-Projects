...
Fl_Window* make_window()
{
	Fl_Window* w;
	{
		...
		// Render Parameters
		{
			Fl_Value_Input* o = jointRadius_input = new Fl_Value_Input(690, 300, 45, 25, "Joint Radius:");
			o->callback((Fl_Callback*)jointRadius_callback);
			jointRadius_input->align(Fl_Align(FL_ALIGN_TOP_RIGHT));
		}

		{
			Fl_Value_Input* o = boneRadius_input = new Fl_Value_Input(690, 350, 45, 25, "Bone Radius:");
			o->callback((Fl_Callback*)boneRadius_callback);
			boneRadius_input->align(Fl_Align(FL_ALIGN_TOP_RIGHT));
		}
		...
		{
			Fl_Light_Button* o = groundPlane_button = new Fl_Light_Button(650, 400, 85, 25, "Ground");
			o->callback((Fl_Callback*)renderGroundPlane_callback, (void*)(0));
			o->align(FL_ALIGN_INSIDE);
		}

		{
			Fl_Light_Button* o = fog_button = new Fl_Light_Button(650, 430, 85, 25, "Fog");
		...
		{
			Fl_Button* o = aboutPlayer_button = new Fl_Button(650, 1600, 85, 25, "About");
